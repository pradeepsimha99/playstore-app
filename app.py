...
# @st.cache_data
# def load_dataset():
#     return pd.read_csv("google_playstore_final_dataset.csv")


# @st.cache_resource
# def load_rating_model():
#     return joblib.load("playstore_rating_model.pkl")


# @st.cache_resource
# def load_popular_model():
#     return joblib.load("popular_app_model.pkl")


# @st.cache_resource
# def load_encoder():
#     return joblib.load("category_encoder.pkl")


# def image_exists(image_name):
#     return os.path.exists(image_name)
...
#     popular_model = load_popular_model()
...
#     col1.metric("Total Apps", f"{total_apps:,}")
#     col2.metric("Average Rating", avg_rating)
#     col3.metric("Total Installs", f"{total_installs:,}")
...
#     charts = [
#         ("Missing Values", "missing_values_apps.png"),
#         ("Rating Distribution", "rating_distribution.png"),
#         ("Top Categories", "top_10_categories.png"),
#         ("Top Installed Categories", "top_categories_installs.png"),
#         ("Feature Importance", "feature_importance_rating_model.png"),
#         ("Actual vs Predicted", "actual_vs_predicted_rating.png")
#     ]
...
#             prediction = rating_model.predict(features)[0]

#             st.success(
#                 f"Predicted Rating: {round(prediction,2)} ⭐"
#             )
...
#     st.title("🔥 Popular App Predictor")
...
#             prediction = popular_model.predict(features)[0]

#             probability = popular_model.predict_proba(features)[0]
...
#                 st.success(
#                     f"🔥 Popular App ({popular_prob}% confidence)"
#                 )

#             else:

#                 st.warning(
#                     f"⚠️ Not Popular App ({100-popular_prob:.2f}% confidence)"
#                 )
...
#     st.title("📱 App Explorer")

#     app_names = sorted(df["App"].unique())
...
#             st.write(
#                 f"**Positive %:** {round(row['Positive_Percent'],2)}"
#             )

#             st.write(
#                 f"**Negative %:** {round(row['Negative_Percent'],2)}"
#             )

#             st.write(
#                 f"**Sentiment Polarity:** {round(row['Avg_Sentiment_Polarity'],3)}"
#             )

#             st.write(
#                 f"**Sentiment Subjectivity:** {round(row['Avg_Sentiment_Subjectivity'],3)}"
#             )
